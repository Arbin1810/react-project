    ...
    <>
      ...
      <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <h2 class="text-3xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
            Shopping Cart
          </h2>
          ...
          <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
            <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
              <div class="space-y-6">
                {cart.length == 0 ? (
                  <h1 className="text-center text-red-500 font-bold text-2xl uppercase">
                    Your Cart is Empty
                  </h1>
                ) : (
                  <>
                          ...
                          <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                            ...
                            <div class="flex items-center gap-4">
                              ...
                              <button
                                type="button"
                                onClick={() => {
                                  removeItems(c.id, c.title);
                                }}
                                class="inline-flex items-center text-3xl font-medium text-red-600 hover:underline dark:text-red-500"
                              >
                                <IoTrashBin />
                              </button>
                            </div>
