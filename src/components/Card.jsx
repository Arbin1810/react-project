...
const Card = (props) => {
  const{title, image, id, description} = props.data
  return (
    <>
      

<div className="max-w-sm w-[21%] bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-3">
    <Link to="#">
